...
CONFIRMATION_SETTLE_WAIT_SECONDS = 3
SUBMIT_CLICK_RETRY_COUNT = 2
SUBMIT_TRANSITION_WAIT_ATTEMPTS = 3
...
PROBE_SHALLOW_SHELL_WAIT_SECONDS = 2
PROBE_SOFT_BLOCKED_SHELL_WAIT_SECONDS = 2
