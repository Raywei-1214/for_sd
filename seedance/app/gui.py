...
class SeedanceMainWindow(QMainWindow):
    ...
    def _build_summary_card(self) -> QFrame:
        ...
        self.available_stat = self._create_stat_card("可用", "0")
        ...
        stats_grid.addWidget(self.available_stat["card"], 1, 0)
    ...
    def _apply_defaults(self) -> None:
        ...
        self.available_stat["value"].setText("0")
    ...
    def _refresh_progress_view(self, progress: BatchProgress) -> None:
        ...
        self.available_stat["value"].setText(str(progress.available_count))
    ...
    def _handle_run_finished(self, summary: BatchSummary) -> None:
        ...
        self.available_stat["value"].setText(str(summary.available_count))
